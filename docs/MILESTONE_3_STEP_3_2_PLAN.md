...
Status: **plan, revision 4.3. Slices 1, 2, 3 and 4a are signed off. The 2026-09-20 review reopened 4b for capability descriptions, identity/choice prose, and knowledge-title attribution. The corrections merged through PR #17 with all three Linux CI jobs green (pull-request run 35565519318, `main` run 35565440664), and the stakeholder signed off 4b on 2026-09-21. Private demo instances, required before 5a, are live and accepted (PRs #18 and #19, `docs/DEMO_VISITOR_ISOLATION_PLAN.md`), including the record lookup the 5a shadow engine will use. Slice 5a may begin, under its mandatory conditions (section 13).**
