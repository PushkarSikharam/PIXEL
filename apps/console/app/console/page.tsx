...
import { AlertTriangle, Network, PlayCircle, Plus, Users } from "lucide-react";
import { useConsole } from "@pixel-console/components/console-context";
import { Alert, Badge, EmptyState, PageHead, Panel, StatusBadge, StatusRaster, type RasterState } from "@pixel-console/components/ui";
    ...
    {first ? null : (
      <Panel title="Elsewhere in Pixel">
        <div className="px-row" style={{ flexWrap: "wrap" }}>
          ...
          <Link className="px-button" href="/console/organization"><Users aria-hidden />People in this organization</Link>
          <Link className="px-button" href="/demo"><PlayCircle aria-hidden />Explore the demo</Link>
          <Link className="px-button" href="/architecture"><Network aria-hidden />How Pixel works</Link>
        </div>
      </Panel>
